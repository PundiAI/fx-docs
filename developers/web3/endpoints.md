...
```json
 {"jsonrpc":"2.0","id":1,"result":"fxcore/0.1.3+/linux/go1.17"}
```
...
Make sure your `fxcored start` call is not using the flag `minimum-gas-prices` because this value will be used instead of the one set on the configuration file.
