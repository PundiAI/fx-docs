...
* [Installing `fxcored`](./#installing-fxcored)
* [f(x)Core Accounts](./#f\(x\)Core-Accounts)
  * [Restoring an Account from the Fundraiser](./#restoring-an-account-from-the-fundraiser)
  * [Creating an Account](./#creating-an-account)
* [Accessing the f(x)Core Network](./#accessing-the-f\(x\)Core-Network)
  * [Running Your Own Full-Node](./#running-your-own-full-node)
  * [Connecting to a Remote Full-Node](./#connecting-to-a-remote-full-node)
* [Setting Up `fxcored`](./#setting-up-fxcored)
* [Querying the State](./#querying-the-state)
* [Sending Transactions](./#sending-transactions)
  * [A Note on Gas and Fees](./#a-note-on-gas-and-fees)
  * [Bonding FX and Withdrawing Rewards](./#bonding-FX-and-withdrawing-rewards)
...
In order to connect to the full-node, you will need an address of the following form: `https://127.0.0.1:26657` (_Note: This is a placeholder_). This address has to be communicated by the full-node operator you choose to trust. You will use this address in the [following section](./#setting-up-fxcored).

## Setting Up `fxcored`

> **Before setting up `fxcored`, make sure you have set up a way to **[**access the f(x)Core network**](./#accessing-the-f\(x\)Core-Network)
...
> **Before you can bond FX and withdraw rewards, you need to **[**set up `fxcored`**](./#setting-up-fxcored)
...
> **Before you can bond FX and withdraw rewards, you need to **[**set up `fxcored`**](./#setting-up-fxcored)** and **[**create an account**](./#creating-an-account)
...
> **Before you can bond FX and withdraw rewards, you need to **[**bond FX**](./#bonding-FX-and-withdrawing-rewards)
...
```bash
fxcored query account <yourAddress> --chain-id fxcore
```
...
```bash
fxcored tx sign unsignedTx.json --from <delegatorKeyName> --offline --chain-id fxcore --sequence <sequence> --account-number <account-number> > signedTx.json
```
